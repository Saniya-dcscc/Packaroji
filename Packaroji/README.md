...
Category pages intentionally use a responsive side-by-side product grid. The homepage packaging-category section remains a slider. Individual product detail pages are normal detail pages without a product-list slider.


## Catalogue update (v44)
- Added the 35 catalogue products from the supplied Packaroji catalogue.
- Reorganized Products into Food Wrapping, Aluminium Foil Packaging, Kraft Paper Packaging, Bakery Packaging, Sugarcane Bagasse, and Takeout & Delivery.
- Added collection destinations for Food Wrapping, Main Portion Packaging, Carry Bags & Pouches, and Branding Options.
- Branding Options shows the full 35-product catalogue as brandable, per the approved website structure.
- Homepage hero, mascot, moving collection slider position, cart/checkout flow, and custom cursor were left in place.
