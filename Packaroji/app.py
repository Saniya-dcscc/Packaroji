...
def product_collection_page(collection_slug):
    ...
    if collection_slug.strip().lower() == "main-portion-packaging":
        ...
        layer2_grouped_products = {
            material: [p for p in products if p.get("category") == material]
            for material in layer2_materials
        }
    ...
    return render_template(
        ...
        category_icon="✨" if collection_slug.strip().lower() == "branding" else "📦",
        is_all_products=False,
        is_collection=True,
        collection_kind=collection["kind"],
        layer2_materials=layer2_materials,
        layer2_grouped_products=layer2_grouped_products,
    )
