...
PRODUCT_CATEGORIES = [
    {"name": "Food Wrapping", "icon": "🧻", "image": "catalogue/kraft-butter-rolls.png", "description": "Foils, kraft paper, butter paper and wrap sheets"},
    {"name": "Aluminium Foil Packaging", "icon": "🥘", "image": "catalogue/foil-single-compartment.png", "description": "Single to multi-compartment foil food packaging"},
    {"name": "Kraft Paper Packaging", "icon": "📦", "image": "catalogue/clamshell-burger-snack-boxes.png", "description": "Trays, tubs, snack pouches, boxes and meal packaging"},
    {"name": "Sugarcane Bagasse", "icon": "🌿", "image": "catalogue/bagasse-single-clamshell.png", "description": "Clamshells, bowls, containers and meal trays"},
    {"name": "Takeout & Delivery", "icon": "🛍️", "image": "catalogue/sos-kraft-bags.png", "description": "Kraft bags for takeaway, delivery and retail orders"},
]
...
PRODUCTS = [
    # Layer 1 — the layer that touches the food directly
    {
        ...
        "best_for": ["Rotis", "Parathas", "Grilled items", "Hot meals"], "image": "catalogue/aluminium-foil-roll.png",
    },
    {
        ...
        "best_for": ["Burgers", "Sandwiches", "Rolls", "Bakery items"], "image": "catalogue/kraft-butter-rolls.png",
    },
    {
        ...
        "best_for": ["Grab-and-go snacks", "Food baskets", "Quick-service wrapping"], "image": "catalogue/wrap-sheets.png",
    },
    {
        ...
        "best_for": ["Cafes", "Bakeries", "Branded food packaging"], "image": "catalogue/branding-options.png",
    },
    ...
    # Layer 2 — Aluminium foil packaging
    {
        ...
        "best_for": ["Biryani", "Rice meals", "Pasta", "Curries", "Takeaway food", "Food delivery"], "image": "catalogue/foil-single-compartment.png",
    },
    {
        ...
        "best_for": ["Main + side dishes", "Rice + curry", "Combo meals"], "image": "catalogue/foil-2-compartment.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Food grade aluminium foil",
        "features": ["Food grade material", "Lightweight & durable", "Ideal for hot food", "Available in multiple sizes"],
        "best_for": ["Complete meals", "Multiple sides", "Thali options"], "image": "catalogue/foil-3-compartment.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Food grade aluminium foil",
        "features": ["Food grade material", "Lightweight & durable", "Ideal for hot food", "Available in multiple sizes"],
        "best_for": ["Full meals", "Multi-cuisine combos", "Thali options"], "image": "catalogue/foil-4-compartment.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Food grade aluminium foil",
        "features": ["Food grade material", "Lightweight & durable", "Ideal for hot food", "Available in multiple sizes"],
        "best_for": ["Salads", "Gravies", "Curries", "Desserts", "Baked items"], "image": "catalogue/foil-round.png",
    },
    ...
    # Layer 2 — Kraft paper packaging
    {
        ...
        "best_for": ["Nachos", "Fries", "Tacos", "Fried snacks", "Finger foods"], "image": "catalogue/open-food-trays-boats.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Kraft paper", "features": ["Food grade material", "Grease resistant", "Biodegradable", "Available in multiple sizes"],
        "best_for": ["French fries", "Churros", "Nuggets", "Popcorn", "Wraps"], "image": "catalogue/scoops-snack-pouches.png",
    },
    {
        ...
        "best_for": ["Burgers", "Foot long subs", "Fried chicken", "Wraps", "Frankie rolls", "Sandwiches"], "image": "catalogue/clamshell-burger-snack-boxes.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Kraft paper", "features": ["Food grade material", "Grease resistant", "Microwave safe", "Biodegradable", "Available in multiple sizes"],
        "best_for": ["Soups", "Gravies", "Desserts", "Ice cream", "Grain bowls"], "image": "catalogue/round-tall-flat-tubs.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Kraft paper", "features": ["Food grade material", "Grease resistant", "Microwave safe", "Biodegradable", "Available in multiple sizes"],
        "best_for": ["Layer meals", "Biryani", "Meal combos", "Gourmet mains"], "image": "catalogue/rectangular-meal-boxes.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Kraft paper", "features": ["Food grade material", "Grease resistant", "Microwave safe", "Biodegradable", "Available in multiple sizes"],
        "best_for": ["Noodles", "Fried rice", "Salads", "Pastas", "Bakery items"], "image": "catalogue/folded-boxes.png",
    },
    ...
    # Layer 2 — Bakery packaging
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Kraft paper", "features": ["Food grade material", "Grease resistant", "Microwave safe", "Biodegradable", "Available in multiple sizes"],
        "best_for": ["Fried rice", "Noodles", "Pasta", "Salads", "Hot combos"], "image": "catalogue/folded-boxes-v2.png",
    },
    {
        ...
        "best_for": ["Dry fruits", "Coffee beans", "Breads", "Snacks"], "image": "catalogue/stand-up-pouches-bags.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Kraft paper", "features": ["Food grade material", "Grease resistant", "Microwave safe", "Biodegradable", "Available in multiple sizes"],
        "best_for": ["Cakes", "Pastries", "Picnic packs", "Gift hampers"], "image": "catalogue/dome-cake-box.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Kraft paper", "features": ["Food grade material", "Grease resistant", "Microwave safe", "Biodegradable", "Available in multiple sizes"],
        "best_for": ["Cupcakes", "Muffins", "Brownies", "Donuts", "Tea cakes"], "image": "catalogue/window-bakery-boxes.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Kraft paper", "features": ["Food grade material", "Grease resistant", "Microwave safe", "Biodegradable", "Available in multiple sizes"],
        "best_for": ["Whole cakes", "Cheesecakes", "Pies", "Premium bakes"], "image": "catalogue/cake-tart-boxes.png",
    },
    ...
    # Layer 2 — Sugarcane bagasse
    {
        ...
        "best_for": ["Gourmet burgers", "Sandwiches", "Bagels", "Sliders"], "image": "catalogue/bagasse-single-clamshell.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Sugarcane bagasse", "features": ["Food grade material", "Oil & water resistant", "Microwave safe", "Freezer safe", "Available in multiple sizes"],
        "best_for": ["Biryani", "Fried rice", "Pasta", "Noodles", "Salads", "Continental mains"], "image": "catalogue/bagasse-long-clamshell.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Sugarcane bagasse", "features": ["Food grade material", "Oil & water resistant", "Microwave safe", "Freezer safe", "Available in multiple sizes"],
        "best_for": ["Rice + curry combos", "Main + starter", "Meal pairings"], "image": "catalogue/bagasse-2-compartment-clamshell.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Sugarcane bagasse", "features": ["Food grade material", "Oil & water resistant", "Microwave safe", "Freezer safe", "Available in multiple sizes"],
        "best_for": ["Executive combos", "Main with sides", "Multi-curry lunch sets"], "image": "catalogue/bagasse-3-compartment-clamshell.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Sugarcane bagasse", "features": ["Food grade material", "Oil & water resistant", "Microwave safe", "Freezer safe", "Available in multiple sizes"],
        "best_for": ["Salads", "Poke bowls", "Curries", "Gravies", "Desserts"], "image": "catalogue/bagasse-round-bowls.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Sugarcane bagasse", "features": ["Food grade material", "Oil & water resistant", "Microwave safe", "Freezer safe", "Available in multiple sizes"],
        "best_for": ["Biryani", "Gourmet pastas", "Noodle bowls"], "image": "catalogue/bagasse-oval-meal-container.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Sugarcane bagasse", "features": ["Food grade material", "Oil & water resistant", "Microwave safe", "Freezer safe", "Available in multiple sizes"],
        "best_for": ["Biryani", "Pasta", "Rice bowls", "Continental mains", "Salads"], "image": "catalogue/bagasse-single-container.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Sugarcane bagasse", "features": ["Food grade material", "Oil & water resistant", "Microwave safe", "Freezer safe", "Available in multiple sizes"],
        "best_for": ["Rice + curry combos", "Main + starter", "Chinese bowls"], "image": "catalogue/bagasse-2-container.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Sugarcane bagasse", "features": ["Food grade material", "Oil & water resistant", "Microwave safe", "Freezer safe", "Available in multiple sizes"],
        "best_for": ["Mini thalis", "Executive combos", "Roti + dal + sabzi sets"], "image": "catalogue/bagasse-3-meal-tray.png",
    },
    {
        ...
        "sizes": "Available in multiple sizes.", "material": "Sugarcane bagasse", "features": ["Food grade material", "Oil & water resistant", "Microwave safe", "Freezer safe", "Available in multiple sizes"],
        "best_for": ["Premium executive thalis", "South Indian meals", "Complete combos"], "image": "catalogue/bagasse-4-meal-tray.png",
    },
    {
        ...
        "best_for": ["Grand Indian thalis", "Corporate lunch boxes", "Multi-course platters"], "image": "catalogue/bagasse-round-bowls-tray.png",
    },
    ...
    # Layer 3 — takeout & delivery
    {
        ...
        "best_for": ["Bakery items", "Sandwiches", "Grocery deliveries", "Over-the-counter takeaways"], "image": "catalogue/sos-kraft-bags.png",
    },
    {
        ...
        "best_for": ["Broad base containers", "Meal box combos", "Bakery boxes", "Fast food takeouts"], "image": "catalogue/wide-base-die-cut-bags.png",
    },
    {
        ...
        "best_for": ["Multi-item deliveries", "Cloud kitchen orders", "Retail takeaways", "Premium brand packaging"], "image": "catalogue/sos-kraft-bags-heavy.png",
    },
    {
        ...
        "best_for": ["Heavy food containers", "Thali boxes", "Cake boxes", "Doorstep delivery"], "image": "catalogue/wide-base-die-cut-bags-white.png",
    },
]
