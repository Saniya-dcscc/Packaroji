...
def checkout():
    ...
    # Tell the next page to show the success cursor once.
    session["packaroji_order_success_cursor"] = True
...
def customer_order_detail(
    ...
    order_success_cursor = bool(
        session.pop("packaroji_order_success_cursor", False)
    )

    return render_template(
        "order_detail.html",
        order=order,
        order_success_cursor=order_success_cursor
    )
