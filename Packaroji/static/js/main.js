document.addEventListener("DOMContentLoaded", () => {
    ...
    (() => {
        const initMascotEyes = () => {
            ...
            const pupils = [
                { el: leftPupil, cx: 121, cy: 151 },
                { el: rightPupil, cx: 199, cy: 151 },
            ];
    ...
    /* =========================================================
       PRODUCT CAROUSEL — CONTINUOUS INFINITE 3D ARC (v35)
    ...
    (() => {
        ...
        sliders.forEach((slider) => {
            ...
            const metrics = () => {
                ...
                if (w <= 600) {
                    cardWidth = Math.min(220, Math.max(170, w * 0.66));
                    spacing = cardWidth * 1.12;
                } else if (w <= 980) {
                    cardWidth = Math.min(235, Math.max(190, w * 0.38));
                    spacing = cardWidth * 1.13;
                } else {
                    cardWidth = Math.min(250, Math.max(220, w * 0.205));
                    spacing = cardWidth * 1.12;
                }
            ...
            const speed = () => window.innerWidth <= 600 ? 0.24 : window.innerWidth <= 980 ? 0.22 : 0.20;
