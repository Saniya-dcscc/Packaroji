        ...
        sliders.forEach((slider) => {
            ...
            const render = () => {
                ...
                slides.forEach((slide) => {
                    ...
                    const scale = 1.02 - Math.min(0.20, ratio * 0.13);
                    const rotateY = sign * Math.min(23, ratio * 18);
                    const rotateZ = sign * Math.min(2.5, ratio * 2);
                    const y = Math.min(34, ratio * ratio * 26);
                    const z = Math.round(120 - ratio * 55);
                    const opacity = Math.max(0.38, 1 - Math.max(0, ratio - 0.8) * 0.65);
