document.addEventListener("DOMContentLoaded", () => {
    ...
    /* =========================================================
       PRODUCT CAROUSEL — SIMPLE SINGLE-CARD SLIDER (v33)
       Homepage only. One card fully visible at a time; the track
       slides via transform: translateX(). No 3D, no absolute
       positioning, no opacity blending — overlap is not possible.
    ========================================================== */
    (() => {
