/* =========================================================
   ...
   1. "Back to shop": any element with the attribute
      ...
      "Continue Shopping".
   2. Add to cart: successful cart-add handlers call
      window.PackarojiCursor.flash('happy') only after the server
      confirms the add. This includes the main product/category
      handler, the product-page handler, and customization add.
